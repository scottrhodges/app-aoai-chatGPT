                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Start chatting away</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>This AI chatbot is configured to answer your questions</h2>
                            </Stack>
                        ) : (
